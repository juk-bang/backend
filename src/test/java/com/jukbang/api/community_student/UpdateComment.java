...
public class UpdateComment extends BaseControllerTest {
    ...
    @Test
    @DisplayName("커뮤니티(학생)_댓글 수정하기 (성공)")
    void UpdateCommentSuccess() throws Exception {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.put("/community/{role}/{univId}/{postId}/comments/{commentId}","student",1,postId,commentId)
