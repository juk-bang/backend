...
@DisplayName("추천 필터 가져오기")
public class GetRecommendFilter extends BaseControllerTest {
  ...
  @DisplayName("추천 필터 가져오기 (성공)")
  void getRecommendFilterSuccess() throws Exception {
    ...
    ;
      ...
      this.mockMvc.perform(RestDocumentationRequestBuilders.get("/rooms/filter/1"))
          .andExpect(status().isOk())
          .andDo(print())
          .andDo(document("getRecommendFilter"))
      ;
  }
