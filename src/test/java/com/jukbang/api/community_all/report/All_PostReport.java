...
public class All_PostReport extends BaseControllerTest {
    ...
    void reportPostSuccess() throws Exception {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.post("/community/{role}/{univId}/{postId}/report","all",1,postId)
