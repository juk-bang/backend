...
public class DeletePostReportOnly extends BaseControllerTest {
    @Autowired
    PostReportService postReportService ;

    @Test
    @DisplayName("신고한 커뮤니티 게시글 잔류하기 (성공)")
    void deleteReportPostSuccess() throws Exception{
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.delete("/admin/report/community/{reportid}",postReportId)
                .header("Authorization", "Bearer " + accessToken))
                .andExpect(status().isOk())
                .andDo(print())
                .andDo(document("deletePostReportOnly"))
        ;}
}
